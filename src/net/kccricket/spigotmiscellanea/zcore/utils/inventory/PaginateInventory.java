package net.kccricket.spigotmiscellanea.zcore.utils.inventory;
...
public abstract class PaginateInventory<T> extends VInventory {
	...
	@Override
	public InventoryResult openInventory(MiscellaneaPlugin plugin, Player player, int page, Object... args)
