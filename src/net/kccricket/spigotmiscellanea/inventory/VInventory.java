package net.kccricket.spigotmiscellanea.inventory;
...
import net.kccricket.spigotmiscellanea.exceptions.InventoryOpenException;
import net.kccricket.spigotmiscellanea.zcore.utils.ZUtils;
import net.kccricket.spigotmiscellanea.zcore.utils.builder.ItemBuilder;
import net.kccricket.spigotmiscellanea.zcore.utils.inventory.InventoryResult;
import net.kccricket.spigotmiscellanea.zcore.utils.inventory.ItemButton;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected int id;
	protected MiscellaneaPlugin plugin;
	...
	protected InventoryResult preOpenInventory(MiscellaneaPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(MiscellaneaPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, MiscellaneaPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, MiscellaneaPlugin plugin, Player player) {
	}
