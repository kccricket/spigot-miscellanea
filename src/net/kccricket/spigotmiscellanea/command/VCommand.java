package net.kccricket.spigotmiscellanea.command;
...
import net.kccricket.spigotmiscellanea.zcore.utils.commands.Arguments;
import net.kccricket.spigotmiscellanea.zcore.utils.commands.CollectionBiConsumer;
import net.kccricket.spigotmiscellanea.zcore.utils.commands.CommandType;
import net.kccricket.spigotmiscellanea.zcore.utils.commands.Tab;
import net.kccricket.spigotmiscellanea.MiscellaneaPlugin;

public abstract class VCommand extends Arguments {

	protected final MiscellaneaPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(MiscellaneaPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(MiscellaneaPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(MiscellaneaPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(MiscellaneaPlugin plugin, CommandSender sender, String[] args) {
